                ...
                <form wire:submit.prevent="actualizarPrestamo">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="Fecha_prestamo" disabled type="text" class="form-control" id="Fecha_prestamo" placeholder="Fecha Prestamo">@error('Fecha_prestamo') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="ArticuloPrestado"  disabled type="text" class="form-control" id="elementos_id" placeholder="Elementos Id">@error('elementos_id') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
                    ...
                    <input type="text" wire:model="usuarioDeudor" disabled class="form-control" id="usuariodeudor">
                              </select>
                        ...
                        <div class="form-group">
                            ...
                            <label for="" class="form-label">Estado Del Prestamo</label>
                            <select class="form-select " name="" id="">
                                <option >Editar Estado del Prestamo</option>
                                <option value="Activo">Activar</option>
                                <option value="Inactivo">Inactivar</option>
                                <option value="Finalizado">Finalizar Prestamo</option>
                            </select>
