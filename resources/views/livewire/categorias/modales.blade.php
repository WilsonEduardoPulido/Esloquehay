        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-12 ">
                            <h5 class="card-header bi bi-bookmark-star-fill bg-primary text-white">Categoria o Genero literario:{{ $nombre }}</h5>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                               
                                <p class="card-text bi bi-caret-right-fill">Tipo :{{ $Tipo }}</p>
                                <p class="card-text bi bi-caret-right-fill">Descripcion:{{ $descripcion }}</p>
